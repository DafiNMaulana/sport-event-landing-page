...
<!--   <a href="#">
  ...
  <h3 align="center">Sport event template</h3>

  <p align="center">
    flat landing page sport event bootstrap 5
<!--     <br />
...
<img src="https://github.com/DafiNMaulana/Best-README-Template/blob/main/images/Screenshot%20(2).png" alt="projects screenshot">
...
1. Clone the repo
   ```
   $git clone https://github.com/DafiNMaulana/sport-event-landing.git
   ```
